...
const health_js_1 = require("./health/health.js");
const hit_js_1 = require("./hit.js");
const jump_js_1 = require("./jump.js");
const move_js_1 = require("./move.js");
const reclining_js_1 = require("./reclining/reclining.js");
...
const health = new health_js_1.Health(person);
const reclining = new reclining_js_1.Reclining(person);
const reclining1 = new reclining_js_1.Reclining(person1);
const health1 = new health_js_1.Health(person1);
const move = new move_js_1.Move(person);
const checkHit = new checkHit_js_1.CheckHit(person, person1, health, health1, reclining, reclining1);
